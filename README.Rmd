...
At a bare minimum you will need the `tidyverse` package installed, which is a meta-package that loads 8 individual package all focused on tidy analysis.
...
Running the following line of code will install all the required packages.
